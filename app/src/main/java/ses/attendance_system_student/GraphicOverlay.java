...
public class GraphicOverlay extends View {
     ...
     * instances to the overlay using {@link ses.attendance_system_student.GraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        private ses.attendance_system_student.GraphicOverlay overlay;

        public Graphic(ses.attendance_system_student.GraphicOverlay overlay) {
