...
public class FaceContourGraphic extends ses.attendance_system_student.GraphicOverlay.Graphic {
  ...
  public FaceContourGraphic(ses.attendance_system_student.GraphicOverlay overlay) {
    super(overlay);
